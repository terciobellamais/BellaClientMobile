...
with_node \
  ...
  --target "/Users/tercio/Documents/BellaClientMobile/ios/Pods/Target Support Files/Pods-Bella/ExpoModulesProvider.swift" \
  --entitlement "/Users/tercio/Documents/BellaClientMobile/ios/Bella/Bella.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
